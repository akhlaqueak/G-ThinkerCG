...
with open("Exp2c_res1.txt","r") as f:
	str1=f.readline()
	i=0
...
with open("Exp2c_res2.txt","r") as f:
	str1=f.readline()
	i=0
	while str1 is not None and str1 != '':
		res2[i]=float(str1)
...
ax.set_yticklabels(['$10^{-1}$','$10^0$','$10^1$','$10^2$','$10^3$'],fontsize=12.5)
ax.legend(fontsize=12.5,bbox_to_anchor=(0.5, 1.12),ncol=1)
fig=plt.gcf();
fig.tight_layout()
fig.set_size_inches(4.33,2.3622)
plt.savefig("./Figure8c.pdf",dpi=400,bbox_inches="tight")