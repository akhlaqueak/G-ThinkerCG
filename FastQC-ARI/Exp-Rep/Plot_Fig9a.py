...
res1=[]
with open("Exp3a_res1.txt","r") as f:
	str1=f.readline()
...
res2=[]
with open("Exp3a_res2.txt","r") as f:
	str1=f.readline()
	while str1 is not None and str1 != '':
...
plt.yticks([1,10,100,1000],['$10^0$','$10^1$','$10^2$','$10^3$'],fontsize=12.5)
...
plt.savefig("./Figure9a.pdf",dpi=400,bbox_inches="tight")