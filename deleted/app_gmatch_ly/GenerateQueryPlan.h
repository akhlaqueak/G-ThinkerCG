...
public:
    ...
    static ui selectGQLStartVertex(Graph_CPU &query_graph, ui *candidates_count) 
    {
        /**
    ...
    static void updateValidVertices(Graph_CPU &query_graph, ui query_vertex, std::vector<bool> &visited,
    ...
    static void generateGQLQueryPlan(Graph_CPU &data_graph, Graph_CPU &query_graph, ui *candidates_count,
                                    ui *&order, ui *&pivot) 
    {
        /**
