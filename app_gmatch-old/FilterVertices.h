...
public:
    ...
    static void allocateBuffer(Graph_CPU &data_graph, Graph_CPU &query_graph, ui** &candidates, ui* &candidates_count)
    {
    ...
    static bool LDFFilter(Graph_CPU &data_graph, Graph_CPU &query_graph, ui** &candidates, ui* &candidates_count)
    {
    ...
    static void computeCandidateWithLDF(Graph_CPU &data_graph, Graph_CPU &query_graph, ui query_vertex,
                                        ui &count) 
    {
    ...
    static ui selectDPisoStartVertex(Graph_CPU &data_graph, Graph_CPU &query_graph, ui *&candidates_count) 
    {
    ...
    static void bfsTraversal(Graph_CPU &graph, ui root_vertex, TreeNode * &tree, ui * &bfs_order) 
    {
    ...
    static void generateDPisoFilterPlan(Graph_CPU &data_graph, Graph_CPU &query_graph, TreeNode *&tree,
    ...
    static void pruneCandidates(Graph_CPU &data_graph, Graph_CPU &query_graph, ui query_vertex, ui *pivot_vertices, 
    ...
    static bool DPisoFilter(Graph_CPU &data_graph, Graph_CPU &query_graph, ui **&candidates, ui *&candidates_count, 
